...
<h2>Description</h2>
This project consists of setting up 2 VMs, emulating an adversary, and blocking an attack. In the final section, I also block a ransomware attack from a ransomware simulator, Quickbuck.
<br />
